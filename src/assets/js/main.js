...
window.addEventListener("load", function () {
  ...
  let dataBasePhone = [
    {
      ...
      text: "Замена задней камеры на новую, оригинальную. Гарантия на повторную поломку.",
    },
    {
      character: "Не работает камера",
      ...
      text: "Замена передней камеры на новую, оригинальную. Гарантия на повторную поломку.",
    },
    {
      character: "Не работает камера",
      type: "Ремонт платы",
      ...
      text: "Профессиональный ремонт материнской платы, лучшие специалисты. Гарантия на повторную поломку.",
    },
    {
      ...
      text: "При замене перестаёт работать сенсор отпечатка пальца. В некоторых случаях, можно сделать ремонт старой кнопки.",
    },
    {
      character: "Проблема с кнопками",
      ...
      text: "Замена кнопки включения на новую, оригинальную. Гарантия на повторную поломку.",
    },
    {
      character: "Проблема с кнопками",
      ...
      text: "Замена кнопкок громкости на новую, оригинальную. Гарантия на повторную поломку.",
    },
    {
      ...
      text: "Замена или ремонт разъема. Оригинальные детали, лучшее качество, гарантия на повторную поломку.",
    },
    {
      character: "Не работают наушники",
      type: "Ремонт платы",
    ...
    },
    {
      ...
      text: "С данной проблемой может быть связано множество поломок. Поэтому она требует диагностики для выяснения точной причины.",
    },
    {
      character: "Греется",
      type: "Ремонт платы",
    ...
    },
    {
      ...
      text: "Замена аккумулятора на новый, оригинальный. Лучшее качество, гарантия на повторную поломку.",
    },
    {
      character: "Не заряжается",
      type: "Замена разъема",
      ...
      text: "Замена или ремонт разъема требуется если устройство перестало заряжаться. Оригинальные детали, гарантия на повторную поломку.",
    },
    {
      character: "Не заряжается",
      type: "Ремонт платы",
    ...
    },
    {
      ...
      text: "Замена верхнего динамика. Оригинальные детали, лучшее качество, гарантия на повторную поломку.",
    },
    {
      character: "Проблема с динамиками",
      ...
      text: "Замена нижнего динамика. Оригинальные детали. Лучшее качество, гарантия на повторную поломку.",
    },
    {
      character: "Проблема с динамиками",
      type: "Ремонт платы",
    ...
    },
    {
      ...
      text: "Замена антенны при отсутствии или плохой сети. Оригинальные детали, лучшее качество, гарантия на повторную поломку.",
    },
    {
      character: "Нет сети",
      type: "Ремонт платы",
    ...
    },
    {
      ...
      text: "При сбое устройства наши профессионалы выполнят перепрошивку с гарантией от превращение устройства в неработающий кирпич.",
    },
    {
      character: "Просит iTunes или завис",
      type: "Ремонт платы",
    ...
    },
    {
      ...
      text: "Производится расклейка модуля и замена стекла, поляризационной пленки, рамки, акустического уха с сеткой для динамика, модуля подсветки. При этом сохраняется оригинальная матрица с сенсором.",
    },
    {
      character: "Разбит дисплей",
      ...
      text: "Оригинальный экран мы берем с другого оригинального iPhone. Лучшее качество, гарантия на повторную поломку.",
    },
    {
      character: "Разбит дисплей",
      ...
      text: "Установка аналогово дисплея. Функции 3D Touch и TrueTone могут работать нестабильно.",
    },
    {
      ...
      text: "Замена датчика приблежения. Оригинальные детали, лучшее качество, гарантия на повторную поломку.",
    },
    {
      character: "Не гаснет при разговоре",
      type: "Ремонт платы",
    ...
    },
    {
      ...
      text: "Замена антенны при отсутствии или плохого сигнала Wi-Fi. Оригинальные детали, лучшее качество, гарантия на повторную поломку.",
    },
    {
      character: "Не ловит Wi-Fi",
      type: "Ремонт платы",
    ...
    },
    {
      ...
      text: "Замена или ремонт разъема требуется если устройство перестало заряжаться. Ориниальные детали, гарантия на повторную поломку.",
    },
    {
      character: "Не включается",
      type: "Ремонт платы",
    ...
    },
    {
      ...
      text: "Замена корпусных деталей. Лучшее качество, гарантия.",
    },
    {
      character: "Разбитая задняя крышка",
      ...
      text: "Замена стекла задней крышки. Лучшее качество, гарантия.",
    },
    {
      ...
      text: "Замена светодиода при тусклой или неработающей вспышки фотокамеры. Лучшие детали, гарантия на повторную поломку.",
    },
    {
      character: "Не работает вспышка",
      type: "Ремонт платы",
    ...
    },
    {
      ...
      text: "Замена или ремонт разъема сим карты. Лучшие детали, гарантия на повторную поломку.",
    },
    {
      character: "Не видит сим карту",
      type: "Ремонт платы",
    ...
    },
    {
      ...
      text: "Замена модуля памяти на более большой объем. Только оригинальные модули. Гарантия на поломку.",
    },
    {
      ...
      text: "Замена вибромотора на устройстве. Лучшие детали. Гарантия на повторную поломку.",
    },
    {
      character: "Не работает вибро",
      type: "Ремонт платы",
    ...
    },
    {
      ...
      text: "Замена антенны. Оригинальные детали. Лучшее качество, гарантия на повторную поломку.",
    },
    {
      character: "Не работает PayPass",
      type: "Ремонт платы",
  ...
  let dataBaseInfoPad = [
    ...
    },
    {
      ...
      guarantee: "60",
      timing: "3 часа",
      text: "Физическое и удаленное снятие блокировки активации на iPad. Лучшие специалисты, гарантия.",
    },
    {
      type: "Увеличение памяти",
      guarantee: "60",
  ...
  let dataBaseInfoWatch = [
    ...
    },
    {
      ...
      guarantee: "60",
      timing: "от 3 часов",
      text: "Появились цветные полосы, не работает тачскрин. Оригинальные детали. Гарантия на повторную поломку",
    },
    {
      type: "Чистка от воды",
      guarantee: "60",
      timing: "40 минут",
      text: "Чистка ваших Watch после попадания влаги. После чистки производится диагностика.",
    },
  ];
  let dataBasePad = [
    {
  ...
  document.querySelector("body").addEventListener("click", function (event) {
                    ...
                    item.info.forEach((innerItem, index) => {
                      ...
                      <label class="calculator__step-block-card" for="step-four-${index}">
                        <div class="calculator__step-block-card-top">
                          ...
                          <div class="calculator__step-block-card-price">${innerItem.price} ${innerItem.price !== "бесплатно" ? "грн." : ""}</div>
                        </div>
                        <div class="calculator__step-block-card-top">
    ...
    if (event.target.closest(".calculator__step-edit")) {
      ...
      topBgCalculator =
        ...
        document.querySelector(".calculator--active").scrollTop +
        "px";
      document.querySelector(".calculator__step-inner").classList.remove("calculator__step-inner--hidden");
      document.querySelector(".calculator__step-finish").classList.remove("calculator__step-finish--visibility");
    }
      ...
      if (!removeElement) {
        ...
        <label class="calculator__step-block-card" for="step-four-${index + 1}">
          <div class="calculator__step-block-card-top">
            ...
            <div class="calculator__step-block-card-price">${price} ${price !== "бесплатно" ? "грн." : ""}</div>
          </div>
          <div class="calculator__step-block-card-top">
